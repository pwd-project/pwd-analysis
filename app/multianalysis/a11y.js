...
module.exports = {
    names: [ 'ariaOnReservedElement', 'ariaOwnsDescendant', 'ariaRoleNotScoped', 'audioWithoutControls', 'badAriaAttribute',
             'badAriaAttributeValue', 'aria', 'labels', 'duplicateId', 'focusableElementNotVisibleAndNotAriaHidden',
    ...
    run: function (page, callback) {
        ...
        return page.evaluate(function () {
                ...
                var codes = ['AX_ARIA_09', 'AX_ARIA_04', 'AX_ARIA_01', 'AX_TEXT_01', 'AX_HTML_02',
                             ...
                             'AX_COLOR_01', 'AX_ARIA_12', 'AX_ARIA_06', 'AX_AUDIO_01', 'AX_ARIA_11',
                             'AX_IMAGE_01', 'AX_FOCUS_01', 'AX_COLOR_01', 'AX_ARIA_05', 'AX_ARIA_07'];
